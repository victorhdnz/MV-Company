            ...
            {formData.testimonials_enabled && (
              <>
                ...
                <div>
                  ...
                  <Input
                    type="number"
                    value={formData.testimonials_duration || 60}
                    onChange={(e) => setFormData({ ...formData, testimonials_duration: parseInt(e.target.value) || 60 })}
                    placeholder="60"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Tempo em segundos para uma rotação completa (padrão: 60s - mais lento)
                  </p>
                </div>
                <div className="border-t border-gray-200 pt-4 mt-4">
                  <TestimonialsManager
