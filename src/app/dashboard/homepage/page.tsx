            ...
            {formData.testimonials_enabled && (
              <>
                ...
                <div>
                  ...
                  <Input
                    type="number"
                    value={formData.testimonials_duration || 150}
                    onChange={(e) => setFormData({ ...formData, testimonials_duration: parseInt(e.target.value) || 150 })}
                    placeholder="150"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Tempo em segundos para uma rotação completa (padrão: 150s - extremamente lento)
                  </p>
                </div>
                <div className="border-t border-gray-200 pt-4 mt-4">
                  <TestimonialsManager
